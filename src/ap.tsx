            ...
            />
              ...
              <div className="max-w-7xl mx-auto px-4 py-6 space-y-12">
                ...
                <FeaturedUniversities
                  onSelectUniversity={(name) => setSelectedUniversity(name)}
                />
